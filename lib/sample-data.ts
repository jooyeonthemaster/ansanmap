...
// import { addAnnouncement } from './utils/storage'; // Supabase로 이전하면서 주석 처리

// 한양대 ERICA 캠퍼스 중심점
const CENTER_LAT = 37.2978;
const CENTER_LNG = 126.8378;
  ...
  const sampleBooths: Booth[] = [
    {
      ...
      name: 'ERICA 떡볶이',
      category: 'info',
      description: '매콤달콤한 특제 떡볶이! 순한맛, 중간맛, 매운맛 선택 가능',
      coordinates: [
...
export function initializeSampleData() {
  ...
  // 샘플 공지사항 추가 (Supabase로 이전하면서 주석 처리)
  // addAnnouncement({
  //   title: '🎉 오후 3시 특별 이벤트',
